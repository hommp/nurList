        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <h1>Welcome to nurList</h1>
                        <p>Your ultimate task management solution designed to help you stay organized and boost your
                            productivity.</p>

                        <h3>Our Story</h3>
                        <p>nurList was created out of a passion for helping individuals and teams
                        ...
                        <p>We envision a world where everyone can achieve their goals without the stress of disorganization.
                            With nurList, we aim to empower users to take control of their tasks and maximize their
                            productivity.</p>

                        <p>Thank you for choosing nurList. We’re excited to be part of your journey towards better task
                            management!</p>
                    </div>
                </div>
            </div>
